...
-opaque chunk_range()  :: { chunk_32bit_chunks, uint_32bit(), uint_32bit()}
                        | { chunk_64bit_chunks, uint_64bit(), uint_64bit()}.
-opaque byte_range()   :: { chunk_64bit_bytes,  uint_64bit(), uint_64bit()}.
-opaque bin_number()   :: { chunk_32bit_bins, uint_32bit()}
